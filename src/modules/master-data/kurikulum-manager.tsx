    ...
    <div className="space-y-6">
      <Card className="overflow-hidden border-white/60 bg-white/80 backdrop-blur-md shadow-xl shadow-slate-200/50">
        ...
        <div className="mt-5 overflow-x-auto">
          <Table>
            <THead><TR><TH className="w-12 px-3"><Checkbox checked={items.length > 0 && selectedIds.length === items.length} onCheckedChange={() => toggleAll()} /></TH><TH>Kode</TH><TH>Kurikulum</TH><TH>Prodi</TH><TH>Detail</TH><TH>Status</TH><TH className="w-[160px]">Aksi</TH></TR></THead>
            <TBody>
